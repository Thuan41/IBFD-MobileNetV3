...
def count_macs(model, input_sz, mask=None):
    input=torch.randn(1, 1, input_sz, input_sz)
...
model = mobilenet_v2(num_classes=10, width_mult=0.0001)
#model=(torch.load('D:\HUST\CH-Motor_Research\Code\IBFD_MobileNetV3_AutoCompress\\2022-06-11-15-10-59-567907\\best_result\model.pth'))
