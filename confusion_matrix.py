...
model = mobilenet_v3_small(n_classes=10, width_mult=0.1).to(device)
model.load_state_dict(torch.load('D:\HUST\CH-Motor_Research\Code\IBFD_MobileNetV3_AutoCompress\\epochs\\22061011\\epoch_22061011_100.pth'))
model.eval()
